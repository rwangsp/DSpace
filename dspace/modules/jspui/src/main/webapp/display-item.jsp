...
<dspace:layout style="item" title="<%= title %>">
...
%>
    ...
    { %>
        <div class="panel panel-warning" id="item-admin-sidebar">
...
%>
  ...
  <a href="<%= cc_url %>"><img src="<%= request.getContextPath() %>/image/cc-somerights.png" border="0" alt="Creative Commons" style="margin-top: -5px;" class="pull-right"/></a>
  </p>
<!--
<%= cc_rdf %>
-->
...
%>
  <p class="item-license alert alert-info"><fmt:message key="jsp.display-item.copyright"/></p>
<%
}
%>
